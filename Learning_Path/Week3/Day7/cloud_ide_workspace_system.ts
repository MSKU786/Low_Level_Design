...
3. Workspace configuration: A workspace has: name (required), template (required), runtime settings (CPU cores, memory, disk), environment variables (0-20 key-value pairs), installed extensions (0-50), port forwarding rules (0-10), and git configuration (optional). Constructor would be unmanageable.
